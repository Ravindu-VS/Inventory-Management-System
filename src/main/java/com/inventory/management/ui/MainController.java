...
public class MainController {
...

            {
                ...
                deleteButton.setOnAction(e -> {
                    ...
                    if (confirmed) {
                        ...
                        UIManager.deleteProductFromDB(product);
    ...
    @FXML
    private void onAddProduct() {  // Ensure this method exists and is properly annotated
        try {
            ...
            if (result.isPresent() && result.get() == ButtonType.OK) {
                ...
                if (validateProduct(newProduct, true)) {
                    UIManager.inventory.add(newProduct);
                    UIManager.saveProductToDB(newProduct);
                    // productTable.refresh(); // Not necessary with ObservableList
